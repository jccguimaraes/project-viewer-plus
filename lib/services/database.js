...
import { DESERIALIZER, DATABASE_FILE, ACTION } from './../constants/base';
...
class Database {
   ...
   */
  initialize () {
    const DB_FILE = path.join(atom.configDirPath, DATABASE_FILE);

    return watchPath(atom.configDirPath, {}, events => {
